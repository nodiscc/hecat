...
- tests: refactoring, simplify venv management, fix duplicate targets, fix comments
- tests: add a target to check for newer versions of yt_dlp, schedule it through github actions
